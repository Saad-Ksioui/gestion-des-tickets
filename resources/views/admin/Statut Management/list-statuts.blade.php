            ...
            @foreach ($statuts as $statut)
              <tr>
                ...
                <td
                  ...
                  <a href="{{ route('edit-statut', ['id'=>$statut->id]) }}" class="text-white text-base font-medium bg-[#4DA845] rounded-lg py-1 edit-btn">Edit</a>
                  <form action="{{ route('delete-statut', ['id'=>$statut->id]) }}" method="POST">
                    @csrf
                    @method('DELETE')
