            ...
            @foreach ($categories as $categorie)
              <tr>
                ...
                <td
                  ...
                  <a href="{{ route('edit-categorie', ['id'=>$categorie->id]) }}" class="text-white text-base font-medium bg-[#4DA845] rounded-lg py-1 edit-btn">Edit</a>
                  <form action="{{ route('delete-categorie', ['id'=>$categorie->id]) }}" method="POST">
                    @csrf
                    @method('DELETE')
